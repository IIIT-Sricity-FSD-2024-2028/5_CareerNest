...
| EligibilityCriteria | Conditions such as CGPA, branch, and academic year that decide whether a candidate can apply |
| Application | A candidate’s formal submission for an opportunity through the placement process |
...
- **Outcome / End Condition:**  
  Approved Opportunities are published and made visible to Candidates.

---

### Workflow 2: Candidate Application Process

- **Trigger / Start Condition:**  
  A Candidate views an approved Opportunity.

- **Steps Involved:**  
  1. The Candidate checks the EligibilityCriteria.  
  2. If eligible, the Candidate submits an Application along with a resume.  
  3. The Application is created and its ApplicationStatus is set to *Applied*.  
  4. The Candidate receives a Notification confirming the submission.
...
- **Steps Involved:**  
  ...
  3. Candidates are informed of RecruitmentRound details through Notifications.  
  4. After completion of RecruitmentRounds, the Recruiter updates the final outcome.

- **Outcome / End Condition:**  
  The ApplicationStatus is updated to *Selected* or *Rejected*, and the Candidate
...
- **Trigger / Start Condition:**  
  A Candidate requests a Referral for an existing Application.

- **Steps Involved:**  
  1. The Candidate selects an Alumni and submits a referral request.  
  2. The Alumni reviews the Candidate profile and Application.  
...
- Interview and RecruitmentRound schedules are sometimes shared late or
  through multiple channels, leading to confusion among candidates.
